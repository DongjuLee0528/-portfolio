...
<head>
    ...
    <title>CoMon 서버 - 비밀번호 찾기 페이지</title>
    <link rel="stylesheet" href="../CSS/findPW.css">
</head>
<body>
  <p>비밀번호 찾기</p>
  <div class="find_select">
    <form action="findPW.php">
      <input type="text" class="find_user_ID" placeholder="아이디">
      ...
      <input type="submit" id="submitPW" value="비밀번호 재설정" onclick="window.open('/PHP/findPW_result.php','_blank','width=450, height=500, top=170, left=170')">
    </form>
  </div>
</body>
</html>